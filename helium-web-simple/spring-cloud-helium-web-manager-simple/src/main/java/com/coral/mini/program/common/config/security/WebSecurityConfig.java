...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        for(String url:authConfig.getIgnoreUrls()){
        ...
        registry
                ...
                .addFilter(new JWTAuthenticationFilter(authenticationManager(), authConfig.getTokenRedis(), authConfig.getTokenExpireTime(),
                        redisTemplate, authenticationExtFilter));
