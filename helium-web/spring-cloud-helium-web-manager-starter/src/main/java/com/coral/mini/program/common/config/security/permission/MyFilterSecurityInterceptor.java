package com.coral.mini.program.common.config.security.permission;
...
public class MyFilterSecurityInterceptor extends AbstractSecurityInterceptor implements Filter {
    ...
    public void invoke(FilterInvocation fi) throws IOException, ServletException {
        ...
        try {
            ...
            HttpUtils.response(fi.getResponse(), 401,"未鉴权");
            log.error("MyFilterSecurityInterceptor.invoke:{},{}", fi.getRequestUrl(), e.getMessage());
        } finally {
