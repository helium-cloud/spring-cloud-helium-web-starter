...
public class Snowflake {
    ...
    public static String getSnowflakeId(){
        try {
            return String.valueOf(Snowflake.getInstanceSnowflake().nextId());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String getSnowflakeServerId(){
        try {
            return String.valueOf(Snowflake.getInstanceSnowflake().nextId()).substring(15);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
